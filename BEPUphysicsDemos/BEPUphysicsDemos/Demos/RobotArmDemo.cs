...
namespace BEPUphysicsDemos.Demos
{
 ...
 StandardDemo
#endif
    {
        ...
        {
            base.DrawUI();
            Game.DataTextDrawer.Draw("Arm controls:", new Vector2(500, 20));
#if !WINDOWS
...
#else
            Game.TinyTextDrawer.Draw("Spin base: N M", new Vector2(500, 38));
            Game.TinyTextDrawer.Draw("Bend shoulder: Q W", new Vector2(500, 53));
            Game.TinyTextDrawer.Draw("Bend elbow: R T", new Vector2(500, 68));
            Game.TinyTextDrawer.Draw("Spin forearm: O P", new Vector2(500, 83));
            Game.TinyTextDrawer.Draw("Open/close claw: [ ]", new Vector2(500, 98));
#endif
        }
    }
}