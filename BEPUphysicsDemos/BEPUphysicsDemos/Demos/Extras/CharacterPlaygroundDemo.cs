...
namespace BEPUphysicsDemos.Demos.Extras
{
    ...
    public class CharacterPlaygroundTestDemo : StandardDemo
    {
        ...
        public CharacterPlaygroundTestDemo(DemosGame game)
            : base(game)
        {
        ...
        public override void Update(float dt)
        {
			...
			{
				var p = character.CharacterController.Body.Position;
				foreach (var c in characters)
				{
					p.Y += 2;
					var b = character.CharacterController.Body;
					b.Position = p;
					b.LinearVelocity = Vector3.Zero;
				}
			}
			if (Game.WasKeyPressed(Keys.O))
			{
				var b = character.CharacterController.Body;
				b.Position = new Vector3(-10, 7, 5);
				b.LinearVelocity = Vector3.Zero;
			}
			...
			foreach (var c in characters)
			{
				...
				KeyboardState pressedState;
				var mode =random.Next(10);
				switch (mode)
				{
					default:
						pressedState = new KeyboardState();
						break;
					case 1:
						pressedState = new KeyboardState(Keys.E);
						break;
					case 2:
						pressedState = new KeyboardState(Keys.S);
						break;
					case 3:
						pressedState = new KeyboardState(Keys.F);
						break;
					case 4:
						pressedState = new KeyboardState(Keys.D);
						break;
					case 5:
						pressedState = new KeyboardState(Keys.E, Keys.A);
						break;
					case 6:
						pressedState = new KeyboardState(Keys.S, Keys.A);
						break;
					case 7:
						pressedState = new KeyboardState(Keys.F, Keys.A);
						break;
					case 8:
						pressedState = new KeyboardState(Keys.D, Keys.A);
						break;
					case 9:
						pressedState = new KeyboardState(Keys.A);
						break;
				}

				c.Update(Space.TimeStepSettings.TimeStepDuration, emptyState, pressedState, Game.PreviousGamePadInput, Game.GamePadInput);
			}
            base.Update(dt);
        }
