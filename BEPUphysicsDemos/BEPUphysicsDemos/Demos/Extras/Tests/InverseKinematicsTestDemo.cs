    ...
    public class InverseKinematicsTestDemo : Demo
    {
        ...
        void BuildChain(Vector3 position)
        {
            ...
            for (int i = 1; i < linkCount; i++)
            {
                ...
                var ikAngularFriction = new IKAngularJoint(previousBone, bone) { Stiffness = 0, MaximumForce = 10 };
        ...
        void BuildActionFigure(Vector3 position)
        {
            ...
            joints.Add(new IKTwistLimit(bodyBone, upperLeftArmBone, Vector3.Left, Vector3.Left, MathHelper.PiOver2) { Stiffness = 0.02f, Damping = 0.08f });
            ...
            joints.Add(new IKTwistLimit(upperLeftArmBone, lowerLeftArmBone, Vector3.Left, Vector3.Left, MathHelper.PiOver4) { Stiffness = 0.02f, Damping = 0.08f });
            ...
            joints.Add(new IKTwistLimit(lowerLeftArmBone, leftHandBone, Vector3.Left, Vector3.Left, MathHelper.PiOver4) { Stiffness = 0.02f, Damping = 0.08f });
            ...
            joints.Add(new IKTwistLimit(bodyBone, upperRightArmBone, Vector3.Right, Vector3.Right, MathHelper.PiOver2) { Stiffness = 0.02f, Damping = 0.08f });
            ...
            joints.Add(new IKTwistLimit(upperRightArmBone, lowerRightArmBone, Vector3.Right, Vector3.Right, MathHelper.PiOver4) { Stiffness = 0.02f, Damping = 0.08f });
            ...
            joints.Add(new IKTwistLimit(lowerRightArmBone, rightHandBone, Vector3.Right, Vector3.Right, MathHelper.PiOver4) { Stiffness = 0.02f, Damping = 0.08f });
            ...
            joints.Add(new IKTwistLimit(bodyBone, upperLeftLegBone, Vector3.Up, Vector3.Up, MathHelper.PiOver4) { MeasurementAxisA = Vector3.Normalize(new Vector3(-1, 0, 1)), Stiffness = 0.02f, Damping = 0.08f });
            ...
            joints.Add(new IKTwistLimit(upperLeftLegBone, lowerLeftLegBone, Vector3.Up, Vector3.Up, MathHelper.Pi * .1f) { Stiffness = 0.02f, Damping = 0.08f });
            ...
            joints.Add(new IKTwistJoint(lowerLeftLegBone, leftFootBone, Vector3.Down, Vector3.Down) { Stiffness = 0.02f, Damping = 0.08f });
            ...
            joints.Add(new IKTwistLimit(bodyBone, upperRightLegBone, Vector3.Up, Vector3.Up, MathHelper.PiOver4) { MeasurementAxisA = Vector3.Normalize(new Vector3(1, 0, 1)), Stiffness = 0.02f, Damping = 0.08f });
            ...
            joints.Add(new IKTwistLimit(upperRightLegBone, lowerRightLegBone, Vector3.Up, Vector3.Up, MathHelper.Pi * .1f) { Stiffness = 0.02f, Damping = 0.08f });
            ...
            joints.Add(new IKTwistJoint(lowerRightLegBone, rightFootBone, Vector3.Down, Vector3.Down) { Stiffness = 0.02f, Damping = 0.08f });
