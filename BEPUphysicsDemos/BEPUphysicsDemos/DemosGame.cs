...
#else
            currentSimulation = new Demos.Extras.Tests.RayCastTestDemo(this);// new InverseKinematicsTestDemo(this);// (Demo)Activator.CreateInstance(demoType, new object[] { this });
#endif
