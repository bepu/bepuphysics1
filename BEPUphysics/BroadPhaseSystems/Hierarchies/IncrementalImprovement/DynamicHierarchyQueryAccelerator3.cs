...
namespace BEPUphysics.BroadPhaseSystems.Hierarchies
{
    ...
    ///</summary>
    public class DynamicHierarchyQueryAccelerator3 : IQueryAccelerator
    {
        private readonly DynamicHierarchy3 hierarchy;
        internal DynamicHierarchyQueryAccelerator3(DynamicHierarchy3 hierarchy)
        {
