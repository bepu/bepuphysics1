...
namespace BEPUphysics.DataStructures
{
    ...
    {
        protected internal RawList<T> list;
        ...
        {
            this.list = new RawList<T>(list.Count);
            list.CopyTo(this.list.Elements, 0);
        }
        ...
        {
            list = new RawList<T>(initialCapacity);
        }
        ...
        {
            Array.Copy(list.Elements, 0, array, 0, list.count);
        }
