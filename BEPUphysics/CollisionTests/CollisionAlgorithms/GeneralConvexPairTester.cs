...
namespace BEPUphysics.CollisionTests.CollisionAlgorithms
{
    ...
    public class GeneralConvexPairTester
    {
        ...
        private bool DoDeepContact(out ContactData contact)
        {
            ...
            //    }
            //    MPRTesting.LocalSurfaceCast(collidableA.Shape, collidableB.Shape, ref localTransformB, ref localDirection, out contact.PenetrationDepth, out contact.Normal);
            //    contact.Id = -1;
