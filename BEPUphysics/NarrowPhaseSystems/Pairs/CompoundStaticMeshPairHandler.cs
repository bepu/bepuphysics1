...
namespace BEPUphysics.NarrowPhaseSystems.Pairs
{
    ...
    ///</summary>
    public class CompoundStaticMeshPairHandler : CollidablePairHandler, IPairHandlerParent
    {
        ...
        ///</summary>
        public CompoundStaticMeshPairHandler()
        {
        ...
        internal override void GetContactInformation(int index, out ContactInformation info)
        {
            ...
            throw new IndexOutOfRangeException("Contact index is not present in the compound-static mesh pair.");
