...
namespace BEPUphysics.NarrowPhaseSystems
{
    ...
    public static class NarrowPhaseHelper
    {
        ...
        static NarrowPhaseHelper()
        {
            ...
            collisionManagers.Add(new TypePair(typeof(ConvexCollidable<BoxShape>), typeof(TriangleConvexPairFactory)), triangleConvexFactory);
            collisionManagers.Add(new TypePair(typeof(ConvexCollidable<SphereShape>), typeof(TriangleConvexPairFactory)), triangleConvexFactory);
            collisionManagers.Add(new TypePair(typeof(ConvexCollidable<CapsuleShape>), typeof(TriangleConvexPairFactory)), triangleConvexFactory);
            collisionManagers.Add(new TypePair(typeof(ConvexCollidable<TriangleShape>), typeof(TriangleConvexPairFactory)), triangleConvexFactory);
            collisionManagers.Add(new TypePair(typeof(ConvexCollidable<CylinderShape>), typeof(TriangleConvexPairFactory)), triangleConvexFactory);
            collisionManagers.Add(new TypePair(typeof(ConvexCollidable<ConeShape>), typeof(TriangleConvexPairFactory)), triangleConvexFactory);
            collisionManagers.Add(new TypePair(typeof(ConvexCollidable<TransformableShape>), typeof(TriangleConvexPairFactory)), triangleConvexFactory);
            collisionManagers.Add(new TypePair(typeof(ConvexCollidable<MinkowskiSumShape>), typeof(TriangleConvexPairFactory)), triangleConvexFactory);
            collisionManagers.Add(new TypePair(typeof(ConvexCollidable<WrappedShape>), typeof(TriangleConvexPairFactory)), triangleConvexFactory);
            collisionManagers.Add(new TypePair(typeof(ConvexCollidable<ConvexHullShape>), typeof(TriangleConvexPairFactory)), triangleConvexFactory);
