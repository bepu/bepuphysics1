...
namespace BEPUphysics.NarrowPhaseSystems.Factories
{
    ...
    ///</summary>
    public class MobileMeshStaticMeshPairFactory : NarrowPhasePairFactory
    {
        LockingResourcePool<MobileMeshStaticMeshPairHandler> pool = new LockingResourcePool<MobileMeshStaticMeshPairHandler>();
        ...
        {
            pool.GiveBack(pair as MobileMeshStaticMeshPairHandler);
        }
    }
}
