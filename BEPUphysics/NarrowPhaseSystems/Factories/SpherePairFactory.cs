...
namespace BEPUphysics.NarrowPhaseSystems.Factories
{
    ...
    ///</summary>
    public class SpherePairFactory : NarrowPhasePairFactory
    {
        LockingResourcePool<SpherePairHandler> pool = new LockingResourcePool<SpherePairHandler>();
        ...
        {
            pool.GiveBack(pair as SpherePairHandler);
        }
    }
}
