...
namespace BEPUphysics.NarrowPhaseSystems.Factories
{
    ...
    ///</summary>
    public class CompoundStaticMeshPairFactory : NarrowPhasePairFactory
    {
        LockingResourcePool<CompoundStaticMeshPairHandler> pool = new LockingResourcePool<CompoundStaticMeshPairHandler>();
        ...
        {
            pool.GiveBack(pair as CompoundStaticMeshPairHandler);
        }
    }
}
