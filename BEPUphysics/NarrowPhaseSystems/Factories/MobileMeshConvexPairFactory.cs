...
namespace BEPUphysics.NarrowPhaseSystems.Factories
{
    ...
    ///</summary>
    public class MobileMeshConvexPairFactory : NarrowPhasePairFactory
    {
        LockingResourcePool<MobileMeshConvexPairHandler> pool = new LockingResourcePool<MobileMeshConvexPairHandler>();
        ...
        {
            pool.GiveBack(pair as MobileMeshConvexPairHandler);
        }
    }
}
