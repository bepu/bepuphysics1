...
namespace BEPUphysics.NarrowPhaseSystems.Factories
{
    ...
    ///</summary>
    public class InstancedMeshSpherePairFactory : NarrowPhasePairFactory
    {
        LockingResourcePool<InstancedMeshSpherePairHandler> pool = new LockingResourcePool<InstancedMeshSpherePairHandler>();
        ...
        {
            pool.GiveBack(pair as InstancedMeshSpherePairHandler);
        }
    }
}
