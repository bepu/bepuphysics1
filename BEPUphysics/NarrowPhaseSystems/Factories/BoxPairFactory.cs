...
namespace BEPUphysics.NarrowPhaseSystems.Factories
{
    ...
    ///</summary>
    public class BoxPairFactory : NarrowPhasePairFactory
    {
        LockingResourcePool<BoxPairHandler> pool = new LockingResourcePool<BoxPairHandler>();
        ...
        {
            pool.GiveBack(pair as BoxPairHandler);
        }
    }
}
