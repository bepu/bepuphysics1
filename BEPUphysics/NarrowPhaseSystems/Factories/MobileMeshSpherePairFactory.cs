...
{
    ///<summary>
    /// Manufactures instanced mesh-sphere pairs.
    ///</summary>
    public class MobileMeshSpherePairFactory : NarrowPhasePairFactory
    {
        LockingResourcePool<MobileMeshSpherePairHandler> pool = new LockingResourcePool<MobileMeshSpherePairHandler>();
        ...
        {
            pool.GiveBack(pair as MobileMeshSpherePairHandler);
        }
    }
}
