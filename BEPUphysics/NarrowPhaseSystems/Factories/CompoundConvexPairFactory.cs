...
namespace BEPUphysics.NarrowPhaseSystems.Factories
{
    ...
    ///</summary>
    public class CompoundConvexPairFactory : NarrowPhasePairFactory
    {
        LockingResourcePool<CompoundConvexPairHandler> pool = new LockingResourcePool<CompoundConvexPairHandler>();
        ...
        {
            pool.GiveBack(pair as CompoundConvexPairHandler);
        }
    }
}
