...
namespace BEPUphysics.NarrowPhaseSystems.Factories
{
    ...
    ///</summary>
    public class StaticMeshSpherePairFactory : NarrowPhasePairFactory
    {
        LockingResourcePool<StaticMeshSpherePairHandler> pool = new LockingResourcePool<StaticMeshSpherePairHandler>();
        ...
        {
            pool.GiveBack(pair as StaticMeshSpherePairHandler);
        }
    }
}
