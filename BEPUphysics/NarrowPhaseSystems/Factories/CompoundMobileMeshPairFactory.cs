...
namespace BEPUphysics.NarrowPhaseSystems.Factories
{
    ...
    ///</summary>
    public class CompoundMobileMeshPairFactory : NarrowPhasePairFactory
    {
        LockingResourcePool<CompoundMobileMeshPairHandler> pool = new LockingResourcePool<CompoundMobileMeshPairHandler>();
        ...
        {
            pool.GiveBack(pair as CompoundMobileMeshPairHandler);
        }
    }
}
